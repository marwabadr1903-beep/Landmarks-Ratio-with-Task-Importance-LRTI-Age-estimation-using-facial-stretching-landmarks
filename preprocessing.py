#this code can be applied for MORPH II, FGNET, CACD, AFAD, and UTKFace datasets.
import imageio
import os
import numpy as np
...
morph_orig_dir = '/media/marwa/DATA/fixed_image/'
morph_aligned_dir = '/media/marwa/DATA/fff/'
